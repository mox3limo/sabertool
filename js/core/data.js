...
export let PLAYERS = [
    ...
    {name:"秋山 翔吾(2015)", team:"西武", type:"Legend", avg:0.359, slg:0.522, obp:0.419, ops:0.941, bbk:0.87, hr:14, pa:675, k:78}, // 216安打
    ...
    {name:"松中 信彦(2004)", team:"ダイエー", type:"Legend", avg:0.358, slg:0.715, obp:0.464, ops:1.179, bbk:1.25, hr:44, pa:577, k:67}, // 平成唯一の三冠王
    ...
    // --- レジェンド投手 ---
    {name:"田中 将大(2013)", team:"楽天", type:"Legend", era:1.27, fip:2.00, k9:7.8, bb9:1.4, whip:0.94, ip:212.0, w:24, k:183}, // 24勝0敗
    {name:"ダルビッシュ有(2011)", team:"日本ハム", type:"Legend", era:1.44, fip:1.50, k9:10.7, bb9:1.4, whip:0.83, ip:232.0, w:18, k:276},
    {name:"大谷 翔平(2015)", team:"日本ハム", type:"Legend", era:2.24, fip:2.10, k9:11.0, bb9:2.6, whip:0.91, ip:160.2, w:15, k:196}, // 投手大谷
    {name:"前田 健太(2015)", team:"広島", type:"Legend", era:2.09, fip:2.40, k9:7.6, bb9:1.8, whip:1.01, ip:206.1, w:15, k:175}, // 沢村賞
    ...
    {name:"佐々木 主浩(1998)", team:"横浜", type:"Legend", era:0.64, fip:1.30, k9:12.5, bb9:2.1, whip:0.80, ip:56.0, w:1, k:78}, // 大魔神
    {name:"上原 浩治(1999)", team:"巨人", type:"Legend", era:2.09, fip:2.80, k9:8.2, bb9:1.1, whip:0.90, ip:197.2, w:20, k:179}, // 20勝
    {name:"松坂 大輔(1999)", team:"西武", type:"Legend", era:2.60, fip:3.10, k9:9.0, bb9:4.3, whip:1.17, ip:180.0, w:16, k:151}, // 平成の怪物
    ...
    {name:"江夏 豊(1968)", team:"阪神", type:"Legend", era:2.13, fip:1.80, k9:10.9, bb9:2.6, whip:0.96, ip:329.0, w:25, k:401}, // 401奪三振
    {name:"稲尾 和久(1961)", team:"西鉄", type:"Legend", era:1.69, fip:2.10, k9:7.9, bb9:1.6, whip:0.95, ip:404.0, w:42, k:353},
    {name:"金田 正一(1958)", team:"国鉄", type:"Legend", era:1.30, fip:1.50, k9:8.3, bb9:2.3, whip:0.85, ip:332.1, w:31, k:311}, // 31勝
